<div class="container" id="cartid">
            ...
            <?php if ($this->cart->has_options($items['rowid']) == TRUE): ?>
                <?php foreach ($this->cart->product_options($items['rowid']) as $option_name => $option_value): ?>
                  <?php if($option_name=='image'):?>
                     <td class="invert-image"><a href=""><img src="<?php echo site_url();?>images/products/<?php echo $option_value; ?>" alt=" " style="width:100px;height: 100px;"/></a></td>
                  <?php endif;?>
                <?php endforeach;?>
              <?php endif;?>
      ...
      <div class="checkout-left">
        <div class="checkout-left-basket animated wow slideInLeft" data-wow-delay=".5s">
          <h4><a href="<?php echo site_url();?>checkout/payment">Make Payment</a></h4>
          <ul id="pricee">
            ...
            <li>Grand Total <i>-</i> <span>₹<?php echo number_format($gtotal,2);?>/-<b style="color:green; font-size: 8px;">(Inclusive of all taxes)</b></span></li>
          </ul>
        </div>
